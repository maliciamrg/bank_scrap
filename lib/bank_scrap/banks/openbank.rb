...
module BankScrap
  class Openbank < Bank
    ...
    # Returns an array of BankScrap::OpenbankAccount objects
    def fetch_accounts
      log 'fetch_accounts'
    ...
    #
    # Account should be a BankScrap::OpenbankAccount object
    ...
    # Build an OpenbankAccount object from API data
